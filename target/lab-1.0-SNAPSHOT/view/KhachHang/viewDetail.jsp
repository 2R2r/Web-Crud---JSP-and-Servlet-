...
<div class="container">
    <form action="/khach-hang/add" method="post"  enctype="multipart/form-data">
        <div class="row">
            <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label >Mã</label>
                    <input type="text" class="form-control" required value="${value.ma}" name="ma"
                           readonly>

                </div>
                <div class="form-group">
                    <label >Tên</label>
                    <input type="text" class="form-control" required value="${value.ten}" name="ten"
                           readonly>
