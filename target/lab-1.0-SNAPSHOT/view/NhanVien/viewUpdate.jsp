        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    Nam
                    <input type="radio" required value="Nam" ${value.gioiTinh == 'Nam' ? 'checked' : ''}  name="gioiTinh">
                    Nữ
                    <input type="radio"  required value="Nữ" ${value.gioiTinh == 'Nữ' ? 'checked' : ''} name="gioiTinh">
